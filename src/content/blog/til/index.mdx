...
### TCP - Key TCP Concepts [(2.2)](https://datatracker.ietf.org/doc/html/rfc9293#name-key-tcp-concepts)
...
### TCP - Key Connection State Variables [(3.3.1)](https://datatracker.ietf.org/doc/html/rfc9293#name-key-connection-state-variab)
...
### TCP - State Machine Overview [(3.3.2)](https://datatracker.ietf.org/doc/html/rfc9293#name-current-segment-variables)

...
> . In this case the style is `color: red`
...
In simple words, creating a website is like creating an `*.html` file, where you write code to structure the content of a web page and open the file using browser.
...
And finally, displays the formatted content of the web page based on the HTML code you wrote.

Of course, real-world development is much more than just to create a `*.html` file.

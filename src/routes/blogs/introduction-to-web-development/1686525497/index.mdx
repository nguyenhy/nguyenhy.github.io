...
Front-end web development involves working with `HTML`, `CSS`, and `JavaScript` to create websites and web applications that users can directly interact with.
The core languages used are HTML (HyperText Markup Language), CSS (Cascading Style Sheets), and JavaScript.

To get started with creating a simple website, you need to:
...
## TLDR
You need to learn [HTML](/blogs/introduction-to-html/1645744806/), [CSS](/blogs/introduction-to-css/1646522406/), [JavaScript]()
...
The final result we should point out is to have:
...
<iframe height="300" style="width: 100%;" scrolling="no" title="Introduction To FrontEnd Web Development" src="https://codepen.io/nguyenhy/embed/mdqxbOj?default-tab=html%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
  See the Pen <a href="https://codepen.io/nguyenhy/pen/mdqxbOj">
  Introduction To FrontEnd Web Development</a> by nguyen (<a href="https://codepen.io/nguyenhy">@nguyenhy</a>)
...
Eg: create a tag that make text color is <span style="color: red">red</span>
...
**Question:** So...back to the example above. If the `span` thing can do all the job, why waste time writing down all other (*non-highlight lines down below*) things?

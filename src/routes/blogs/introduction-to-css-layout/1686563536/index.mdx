...
summary: Simple introduction to CSS Layout for absolutely beginner
...
meta:
  ...
  - name: location
    content: Vietnam
  - name: title
    content: Introduction To CSS Layout
  - name: description
    content: Simple introduction to CSS Layout for absolutely beginner
  ...
  - name: og:url
    content: https://nguyenhy.github.io/blogs/introduction-to-css-layout/1686563536/
